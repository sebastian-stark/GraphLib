...
/**
 * Same test as test_example_01.cc. However, the generated route is written to gpx format.
 */
int main(int argc, char *argv[])
{
	...
	// write to gpx
	// (here this ends up in the log file - if the log file is renamed from test_example_03_.log into test_example_03_.gpx, it can be viewed with an appropriate viewer)
	graph.write_gpx(graph_lib_log, shortest_path, "test_track");
